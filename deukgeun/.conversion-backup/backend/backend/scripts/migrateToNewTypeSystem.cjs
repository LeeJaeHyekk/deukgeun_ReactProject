...
module.exports.migrateMachineTable = migrateMachineTable
module.exports.migrateMachineTable = migrateMachineTable
    catch (error) {
...
module.exports.migrateWorkoutGoalTable = migrateWorkoutGoalTable
module.exports.migrateWorkoutGoalTable = migrateWorkoutGoalTable
        `);
...
module.exports.migrateUserTable = migrateUserTable
module.exports.migrateUserTable = migrateUserTable
    catch (error) {
...
module.exports.migrateWorkoutPlanTable = migrateWorkoutPlanTable
module.exports.migrateWorkoutPlanTable = migrateWorkoutPlanTable
    catch (error) {
...
module.exports.migrateWorkoutSessionTable = migrateWorkoutSessionTable
module.exports.migrateWorkoutSessionTable = migrateWorkoutSessionTable
    catch (error) {
...
module.exports.main as migrateToNewTypeSystem = main as migrateToNewTypeSystem;
