...
const { UserReward  } = require('../entities/UserReward');
const { Milestone  } = require('../entities/Milestone');
...
const { WorkoutPlanExercise  } = require('../entities/WorkoutPlanExercise');
const { ExpHistory  } = require('../entities/ExpHistory');
...
module.exports.createTestUsers = createTestUsers,
        {
            ...
            password: await bcrypt.hash(process.env.TEST_USER_PASSWORD || "user123!", 10),
            nickname: "테스트유저1",
            role: "user",
            isEmailVerified: true,
            isActive: true,
        ...
        },
        {
            ...
            password: await bcrypt.hash(process.env.TEST_PREMIUM_PASSWORD || "premium123!", 10),
            nickname: "프리미엄유저",
            role: "user",
            isEmailVerified: true,
            isActive: true,
...
module.exports.createTestGyms = createTestGyms
module.exports.createTestGyms = createTestGyms,
        {
            name: "홍대 피트니스",
...
module.exports.createTestMachines = createTestMachines
module.exports.createTestMachines = createTestMachines,
        {
...
module.exports.createTestWorkoutPlans = createTestWorkoutPlans
module.exports.createTestWorkoutPlans = createTestWorkoutPlans,
        {
            name: "중급자 상체 집중",
...
module.exports.initializeLevelSystem = initializeLevelSystem
module.exports.initializeLevelSystem = initializeLevelSystem,
        });
...
module.exports.createRewardsAndMilestones = createRewardsAndMilestones
module.exports.createRewardsAndMilestones = createRewardsAndMilestones);
...
module.exports.initializeStreaks = initializeStreaks
module.exports.initializeStreaks = initializeStreaks);
...
module.exports.createCommunityPosts = createCommunityPosts
module.exports.createCommunityPosts = createCommunityPosts,
        {
