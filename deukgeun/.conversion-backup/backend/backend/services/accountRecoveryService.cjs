...
const { VerificationToken  } = require('../entities/VerificationToken');
...
class AccountRecoveryService {
    constructor() {
        ...
        this.verificationTokenRepo = AppDataSource.getRepository(VerificationToken);
        this.passwordResetTokenRepo = AppDataSource.getRepository(PasswordResetToken);
...
module.exports.accountRecoveryService = accountRecoveryService = new AccountRecoveryService();
