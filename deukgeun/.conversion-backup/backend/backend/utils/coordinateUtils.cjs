...
function convertWGS84ToTM
module.exports.convertWGS84ToTM = convertWGS84ToTM(lat, lon) {
...
module.exports.convertWGS84ToTM = convertWGS84ToTM
    else {
        rs = 0;
    }
...
function convertTMToWGS84
module.exports.convertTMToWGS84 = convertTMToWGS84(x, y) {
    const DEGRAD = Math.PI / 180.0;
    const re = RE / GRID;
    const slat1 = SLAT1 * DEGRAD;
    const slat2 = SLAT2 * DEGRAD;
...
module.exports.convertTMToWGS84 = convertTMToWGS84;
}
