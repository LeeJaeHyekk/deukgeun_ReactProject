...
function getMachineImage(machineName: string): string {
  ...
  // Try partial match
  for (const [key, value] of Object.entries(IMAGE_MATCHING_CONFIG.MACHINE_IMAGES)) {
...
module.exports = IMAGE_MATCHING_CONFIG
module.exports.getMachineImage = getMachineImage
module.exports.getAllMachineNames = getAllMachineNames
module.exports.searchMachines = searchMachines
module.exports.MACHINE_NAME_MAPPING = MACHINE_NAME_MAPPING