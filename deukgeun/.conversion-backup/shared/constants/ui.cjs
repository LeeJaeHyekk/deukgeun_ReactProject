...
module.exports.LOADING_STATES = LOADING_STATES = {
    IDLE: "idle",
    LOADING: "loading",
    SUCCESS: "success",
    ERROR: "error",
...
// 토스트 타입
const TOAST_TYPES
module.exports.TOAST_TYPES = TOAST_TYPES = {
    SUCCESS: "success",
    ERROR: "error",
    WARNING: "warning",
    INFO: "info",
...
module.exports.TOAST_POSITIONS = TOAST_POSITIONS = {
    TOP_LEFT: "top-left",
...
// 드래그 앤 드롭
const DRAG_DROP
module.exports.DRAG_DROP = DRAG_DROP = {
    DRAG_OVER_CLASS: "drag-over",
    DRAG_ACTIVE_CLASS: "drag-active",
};
// 키보드 단축키
const KEYBOARD_SHORTCUTS
module.exports.KEYBOARD_SHORTCUTS = KEYBOARD_SHORTCUTS = {
    ESCAPE: "Escape",
    ENTER: "Enter",
    SPACE: " ",
    TAB: "Tab",
