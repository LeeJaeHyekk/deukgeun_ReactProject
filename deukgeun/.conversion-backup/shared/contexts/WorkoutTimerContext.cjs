...
function WorkoutTimerProvider
module.exports.WorkoutTimerProvider = WorkoutTimerProvider({ children }: WorkoutTimerProviderProps) {
...
module.exports.useWorkoutTimer = useWorkoutTimer() {
