...
module.exports.useRecaptcha = useRecaptcha(siteKey: string) {
...
const getDummyRecaptchaToken
module.exports.getDummyRecaptchaToken = getDummyRecaptchaToken = (): string => {
...
module.exports.isRecaptchaAvailable = isRecaptchaAvailable = (): boolean => {
  // 개발 환경에서는 항상 사용 가능
  if (process.env.NODE_ENV === "development") {
