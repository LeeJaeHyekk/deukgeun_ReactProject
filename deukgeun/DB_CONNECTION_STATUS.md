...
### 기본 연결 테스트
```bash
mysql -u deukgeun -p'deukgeun_password_2024' -h 127.0.0.1 -P 3306 -e "SELECT 1 as test;"
```

### 데이터베이스 확인
```bash
mysql -u deukgeun -p'deukgeun_password_2024' -h 127.0.0.1 -P 3306 -e "SHOW DATABASES;"
```
