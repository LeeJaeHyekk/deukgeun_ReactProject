...
mysql -u deukgeun -pdeukgeun_password_2024 -h localhost -P 3306 deukgeun_db -e "SELECT 1 as test;"

# 데이터베이스 목록 확인
mysql -u deukgeun -pdeukgeun_password_2024 -h localhost -P 3306 -e "SHOW DATABASES;"
```
