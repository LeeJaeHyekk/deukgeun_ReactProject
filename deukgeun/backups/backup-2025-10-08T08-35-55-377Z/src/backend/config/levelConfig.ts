...
export function getLevelConfig() {
  ...
  return {
    ...
    cooldownTimes:
      levelConfig.cooldownTimes[
        env as keyof typeof levelConfig.cooldownTimes
      ] || levelConfig.cooldownTimes.development,
    dailyExpLimit:
      levelConfig.dailyExpLimits[
        env as keyof typeof levelConfig.dailyExpLimits
      ] || levelConfig.dailyExpLimits.development,
