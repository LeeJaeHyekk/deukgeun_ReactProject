...
const PATH_MAPPINGS = [
  ...
  { from: /from ['"]\.\.\/services\/legacy-crawling-services['"]/g, to: "from '@backend/services/legacyCrawlingServices'" },
  { from: /from ['"]\.\.\/services\/legacyCrawlingServices['"]/g, to: "from '@backend/services/legacyCrawlingServices'" },
  ...
  { from: /from ['"]\.\.\/transformers\/user\.transformer['"]/g, to: "from '@backend/transformers/userTransformer'" },
  { from: /from ['"]\.\.\/transformers\/userTransformer['"]/g, to: "from '@backend/transformers/userTransformer'" },
  { from: /from ['"]\.\.\/transformers\/machine\.transformer['"]/g, to: "from '@backend/transformers/machineTransformer'" },
  { from: /from ['"]\.\.\/transformers\/machineTransformer['"]/g, to: "from '@backend/transformers/machineTransformer'" },
  { from: /from ['"]\.\.\/transformers\/workoutsession\.transformer['"]/g, to: "from '@backend/transformers/workoutsessionTransformer'" },
  { from: /from ['"]\.\.\/transformers\/workoutsessionTransformer['"]/g, to: "from '@backend/transformers/workoutsessionTransformer'" },
  { from: /from ['"]\.\.\/transformers\/post\.transformer['"]/g, to: "from '@backend/transformers/postTransformer'" },
  { from: /from ['"]\.\.\/transformers\/postTransformer['"]/g, to: "from '@backend/transformers/postTransformer'" },
  { from: /from ['"]\.\.\/transformers\/comment\.transformer['"]/g, to: "from '@backend/transformers/commentTransformer'" },
  { from: /from ['"]\.\.\/transformers\/commentTransformer['"]/g, to: "from '@backend/transformers/commentTransformer'" },
  { from: /from ['"]\.\.\/transformers\/like\.transformer['"]/g, to: "from '@backend/transformers/likeTransformer'" },
  { from: /from ['"]\.\.\/transformers\/likeTransformer['"]/g, to: "from '@backend/transformers/likeTransformer'" },
  { from: /from ['"]\.\.\/transformers\/userlevel\.transformer['"]/g, to: "from '@backend/transformers/userlevelTransformer'" },
  { from: /from ['"]\.\.\/transformers\/userlevelTransformer['"]/g, to: "from '@backend/transformers/userlevelTransformer'" },
  { from: /from ['"]\.\.\/transformers\/gym\.transformer['"]/g, to: "from '@backend/transformers/gymTransformer'" },
  { from: /from ['"]\.\.\/transformers\/gymTransformer['"]/g, to: "from '@backend/transformers/gymTransformer'" },
