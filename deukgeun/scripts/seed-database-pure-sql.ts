// ============================================================================
// 순수 SQL 기반 DB Seed 스크립트 - EC2 배포용
// ============================================================================
// TypeORM 엔티티 없이 순수 SQL로 데이터베이스 시드
// EC2 환경에서 안정적으로 실행
...
// 데이터베이스 정리
// ============================================================================
async function clearDatabase(connection: any): Promise<void> {
...
// 기구 데이터 시드
// ============================================================================
async function seedMachines(connection: any): Promise<void> {
...
// 사용자 데이터 시드
// ============================================================================
async function seedUsers(connection: any): Promise<any[]> {
...
// 헬스장 데이터 시드
// ============================================================================
async function seedGyms(connection: any): Promise<void> {
...
// 사용자 레벨 시스템 시드
// ============================================================================
async function seedUserLevels(connection: any, users: any[]): Promise<void> {
...
// 홈페이지 설정 시드
// ============================================================================
async function seedHomePageConfigs(connection: any): Promise<void> {
...
// 커뮤니티 데이터 시드
// ============================================================================
async function seedCommunityData(connection: any, users: any[]): Promise<void> {
...
async function runUnifiedSeed(): Promise<void> {
  ...
  try {
    ...
    // 2. 기구 데이터 시드
    await seedMachines(connection)

    // 3. 사용자 데이터 시드
    const users = await seedUsers(connection)

    // 4. 헬스장 데이터 시드
    await seedGyms(connection)

    // 5. 사용자 레벨 시스템 시드
    await seedUserLevels(connection, users)

    // 6. 홈페이지 설정 시드
    await seedHomePageConfigs(connection)

    // 7. 커뮤니티 데이터 시드
    await seedCommunityData(connection, users)
