// ============================================================================
// Machine Data Update Script (Fixed for Current Schema)
// ============================================================================
...
// SQL 파일 생성
const sqlContent = `-- 기구 데이터 업데이트 SQL (스키마 수정됨)
...
const sqlFilePath = join(__dirname, '../machine_data_update_fixed.sql')
...
machineData.forEach((machine, index) => {
  ...
  console.log(`   - 카테고리: ${machine.category} -> ${mapCategory(machine.category)}`)
