 ...
 */
export const validateCreateMachine = (req: Request, res: Response, next: NextFunction) => {
 ...
 */
export const validateUpdateMachine = (req: Request, res: Response, next: NextFunction) => {
 ...
 * 필터 쿼리 검증
 */
export const validateFilterQuery = (req: Request, res: Response, next: NextFunction) => {
