...
class AdminApiService {
  ...
  async getSystemStats(): Promise<SystemStats> {
    try {
      ...
      if (
        ...
        throw new Error(
          (response.data as any)?.message || 'Failed to fetch system stats'
        )
      }
  ...
  async getDashboardData(): Promise<AdminDashboardData> {
    try {
      ...
      if (!(response.data as any).success || !(response.data as any).data) {
        throw new Error(
          (response.data as any).message || 'Failed to fetch dashboard data'
        )
      }
  ...
  async getAdminSettings(): Promise<AdminSettings> {
    try {
      ...
      if (!(response.data as any).success || !(response.data as any).data) {
        throw new Error(
          (response.data as any).message || 'Failed to fetch admin settings'
        )
      }
  ...
  async updateAdminSettings(
    ...
    try {
      const response = await axios.put<AdminSettings>(
        `${API_ENDPOINTS.BASE_URL}/admin/settings`,
        settings
      )
      ...
      if (!(response.data as any).success || !(response.data as any).data) {
        throw new Error(
          (response.data as any).message || 'Failed to update admin settings'
        )
      }
  ...
  async createDatabaseBackup(): Promise<{
    ...
    try {
      const response = await axios.post(
        `${API_ENDPOINTS.BASE_URL}/admin/backup`
      )

      if (!(response.data as any).success || !(response.data as any).data) {
        throw new Error(
          (response.data as any).message || 'Failed to create database backup'
        )
      }
  ...
  async restartSystem(): Promise<void> {
    try {
      await axios.post(`${API_ENDPOINTS.BASE_URL}/admin/restart`)
    } catch (error) {
  ...
  async clearCache(): Promise<void> {
    try {
      await axios.post(`${API_ENDPOINTS.BASE_URL}/admin/cache/clear`)
    } catch (error) {
  ...
  async updateUserRole(userId: string, role: string): Promise<void> {
    try {
      await axios.put(`${API_ENDPOINTS.BASE_URL}/admin/users/${userId}/role`, {
        role,
      })
    } catch (error) {
  ...
  async deleteUser(userId: string): Promise<void> {
    try {
      await axios.delete(`${API_ENDPOINTS.BASE_URL}/admin/users/${userId}`)
    } catch (error) {
