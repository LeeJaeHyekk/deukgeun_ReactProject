...
export const API_ENDPOINTS = {
  ...
  LEVEL: {
    ...
    GET_USER_LEVEL: '/api/level/current',
    GET_LEVELS: '/api/level/levels',
  ...
  MACHINE: {
    ...
    GET_BY_ID: '/api/machines/:id',
    GET_BY_CATEGORY: '/api/machines/category/:category',
    GET_BY_DIFFICULTY: '/api/machines/difficulty/:difficulty',
    GET_BY_TARGET: '/api/machines/target/:target',
    DETAIL: '/api/machines/:id',
    CATEGORIES: '/api/machines/categories',
    FILTER: '/api/machines/filter',
    SEARCH: '/api/machines/search',
    CREATE: '/api/machines',
    UPDATE: '/api/machines/:id',
  ...
  WORKOUT_GOALS: {
    ...
    GET_BY_ID: '/api/workout-goals/:id',
    CREATE: '/api/workout-goals',
    UPDATE: '/api/workout-goals/:id',
  ...
  COMMUNITY: {
    ...
    LIKE: '/api/posts/:postId/likes',
    UNLIKE: '/api/posts/:postId/likes',
