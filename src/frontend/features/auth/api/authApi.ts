...
import { frontendAppConfig } from "../../../shared/config/app.js"
import { SIGNUP_VALIDATION_MESSAGES } from "../../../shared/constants/validation"
import { HTTP_ERROR_MESSAGES } from "../../../shared/constants/validation"
import type {
  LoginRequest,
  LoginResponse,
  RegisterRequest,
...
export const authApi = {
  ...
  login: async (data: LoginRequest): Promise<ApiLoginResponse> => {
    ...
    const response = await axios.post<BackendLoginResponse>(
      `${frontendAppConfig.apiBaseUrl}${API_ENDPOINTS.AUTH.LOGIN}`,
      data
    )
