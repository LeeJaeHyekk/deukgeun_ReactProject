...
export class MachineApiService {
  ...
  async getMachine(id: number): Promise<{ machine: Machine }> {
    const response = await api.get(API_ENDPOINTS.MACHINE.DETAIL(id))
  ...
  async updateMachine(
    ...
    const response = await api.put(
      API_ENDPOINTS.MACHINE.DETAIL(id),
      data
    )
  ...
  async deleteMachine(id: number): Promise<void> {
    await api.delete(API_ENDPOINTS.MACHINE.DETAIL(id))
  }
  ...
  async getMachinesByCategory(
    ...
    const response = await api.get(
      API_ENDPOINTS.MACHINE.CATEGORY(category)
    )
  ...
  async getMachinesByDifficulty(
    ...
    const response = await api.get(
      API_ENDPOINTS.MACHINE.DIFFICULTY(difficulty)
    )
  ...
  async getMachinesByTarget(
    ...
    const response = await api.get(
      API_ENDPOINTS.MACHINE.TARGET(target)
    )
