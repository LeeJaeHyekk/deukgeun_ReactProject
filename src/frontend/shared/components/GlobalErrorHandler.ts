...
class GlobalErrorHandler {
  ...
  private processError(errorContext: ErrorContext, error: Error) {
    ...
    errorLogger.logError(error, {
      ...
      ...(errorContext.userId && { userId: errorContext.userId }),
      ...(errorContext.sessionId && { sessionId: errorContext.sessionId }),
      ...(errorContext.componentStack && { componentStack: errorContext.componentStack }),
      metadata: {
